...
function tec_to_top_init() {
    ...
    toTopImage.onmouseover = "this.style.backgroundColor = '#f6dd95'";
    toTopImage.onmouseleave = "this.style.backgroundColor = 'rgba(0, 0, 0, 0)'";
    toTopImage.onclick = "tec_to_top_click();";
