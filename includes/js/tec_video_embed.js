...
if(window.innerWidth >= 400 && navigator.userAgentData === undefined) { //firefox, safari, and smaller browser compatibility
...
} else if(window.innerWidth >= 400 && !navigator.userAgentData.mobile) { //screens under 400px are just too small, mobile devices need custom styling
  tec_init_recent_videos_embed();
}