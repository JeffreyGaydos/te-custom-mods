...
if( !function_exists("tec_init") ) {
    function tec_init() {
        wp_enqueue_script( 'tec-init', plugins_url('/js/tec_init.js', __FILE__), '', '1.24');
    }
}
...
if( !function_exists("tec_donation_init") ) {
    function tec_donation_init() {
        wp_enqueue_script( 'tec-donation-init', plugins_url('/js/tec_donation.js', __FILE__), '', '2.7');
    }
}
...
if( !function_exists("tec_header_follow_init") ) {
    function tec_header_follow_init() {
        wp_enqueue_script( 'tec-header-follow-init', plugins_url('/js/tec_header_follow.js', __FILE__), '', '2.2');
    }
}
...
if( !function_exists("tec_random_article_init") ) {
    function tec_random_article_init() {
        wp_enqueue_script( 'tec-random-article-init', plugins_url('/js/tec_random_article.js', __FILE__), '', '2.7');
    }
}
...
if(!function_exists("tec_commission_blurb")) {
    function tec_commission_blurb() {
        if(is_single()) {
            wp_enqueue_script('tec-commission-blurb', plugins_url('/js/tec_commission_blurb.js', __FILE__), '', '1.3');
        }
    }
}
...
if( !function_exists("tec_gallery") ) {
    function tec_gallery() {
        ...
        wp_enqueue_script( 'tec-gallery', plugins_url('/js/tec_gallery.js', __FILE__), '', '2.14');
    }
}
...
if( !function_exists("tec_to_top") ) {
    function tec_to_top() {
        wp_enqueue_script( 'tec-to-top', plugins_url('/js/tec_to_top.js', __FILE__), '', '2.7');
    }
}
    ...
    function tec_video_embed() {
        if(is_single()) {
            ...
            if(!in_category("has-own-video")) {
                wp_enqueue_script( 'tec-video-embed', plugins_url('/js/tec_video_embed.js', __FILE__), '', '2.4');
            } else {
                wp_enqueue_script( 'tec-video-embed-existing', plugins_url('/js/tec_video_embed_existing.js', __FILE__), '', '1.4');
            }
        }
    }
}
...
if( !function_exists("tec_patreon_prompt") ) {
    function tec_patreon_prompt() {
        if(is_single()) {
            wp_enqueue_script( 'tec_patreon_prompt', plugins_url('/js/tec_patreon_prompt.js', __FILE__), '', '1.11');
        }
    }
}
...
if( !function_exists("tec_coauthor_display")) {
    function tec_coauthor_display() {
        ...
        if($users) {
            ...
            if(count($users) > 0) {
                wp_enqueue_script( 'tec-coauthor-display', plugins_url('/js/tec_coauthor_display.js', __FILE__), '', '1.3');
            }
        }
    }
}
...
if( !function_exists("tec_chrome_fixer") ) {
    function tec_chrome_fixer() {
        wp_enqueue_script( 'tec_chrome_fixer', plugins_url('/js/tec_chrome_fixer.js', __FILE__), '', '1.2');
    }
}