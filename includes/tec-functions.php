...
if( !function_exists("tec_init") ) {
    function tec_init() {
        wp_enqueue_script( 'tec-init', plugins_url('/js/tec_init.js', __FILE__), '', '1.30');
    }
}
...
if( !function_exists("tec_dark_mode_init") ) {
    function tec_dark_mode_init() {
        wp_enqueue_script('tec-dark-mode-init', plugins_url('/js/tec_dm_init.js', __FILE__), '', '3.9');
    }
}
...
if( !function_exists("tec_video_embed") ) {
    function tec_video_embed() {
        if(is_single()) {
            wp_enqueue_script( 'tec-video-embed-shared', plugins_url('/js/tec_video_embed_shared.js', __FILE__), '', '1.2');
...
if( !function_exists("tec_patreon_prompt") ) {
    function tec_patreon_prompt() {
        if(is_single()) {
            wp_enqueue_script( 'tec_patreon_prompt', plugins_url('/js/tec_patreon_prompt.js', __FILE__), '', '1.1');
        }
    }
}
...
if( !function_exists("tec_support_display") ) {
    function tec_support_display() {
        ...
        wp_enqueue_script( 'tec-support-display', plugins_url('/js/tec_supporter_display.js', __FILE__), '', '1.45');
    }
}