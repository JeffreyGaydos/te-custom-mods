...
if(!function_exists("tec_commission_blurb")) {
    function tec_commission_blurb() {
        if(is_single()) {
            wp_enqueue_script('tec-commission-blurb', plugins_url('/js/tec_commission_blurb.js', __FILE__), '', '1.4');
        }
    }
}
...
if( !function_exists("tec_patreon_prompt") ) {
    function tec_patreon_prompt() {
        if(is_single()) {
            wp_enqueue_script( 'tec_patreon_prompt', plugins_url('/js/tec_patreon_prompt.js', __FILE__), '', '1.8');
        }
    }
}
