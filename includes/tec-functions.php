...
if( !function_exists("tec_init") ) {
    function tec_init() {
        wp_enqueue_script( 'tec-init', plugins_url('/js/tec_init.js', __FILE__), '', '1.27');
    }
}
...
if( !function_exists("tec_patreon_prompt") ) {
    function tec_patreon_prompt() {
        if(is_single()) {
            wp_enqueue_script( 'tec_patreon_prompt', plugins_url('/js/tec_patreon_prompt.js', __FILE__), '', '1.12');
        }
    }
}
