...
if( !function_exists("tec_init") ) {
    function tec_init() {
        wp_enqueue_script( 'tec-init', plugins_url('/js/tec_init.js', __FILE__), '', '1.7');
    }
}
    ...
    function tec_video_embed() {
        if(is_single()) {
            if(is_single() && !in_category("has-own-video")) {
                ...
                wp_enqueue_script( 'tec-video-embed-existing', plugins_url('/js/tec_video_embed_existing.js', __FILE__), '', '1.18');
            }
        }
    }
}
